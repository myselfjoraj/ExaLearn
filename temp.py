...
def render_email_template(action_url):
    email_template = """
            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="email-masthead">
                  <a class="email-masthead_name">ExaLearn</a>
                </td>
              </tr>
              <!-- Email Body -->
              <tr>
                  ...
                  <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="content-cell">
                        ...
                        <p>Thanks for signing up for ExaLearn! We're excited to have you as an early user.</p>
                        <!-- Action -->
                        ...
                        <p>Thanks,<br>The ExaLearn Team</p>
                        <!-- Sub copy -->
                  ...
                  <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-cell">
                        <p class="sub center">
                          ExaLearn Ltd.
                          <br>EXATECH 3rd Floor, Venjarammoodu, Nellanad, Kerala 695607
                        </p>
                      </td>
                    </tr>
                  </table>
    ...
    """
    return render_template_string(email_template, action_url=action_url)